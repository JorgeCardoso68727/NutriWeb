    ...
    <div class="main-content">
        ...
        <div style="width: 100%; margin-bottom: 12px;">
            <button
                ...
                data-inicio-url="<?= Html::encode(Url::to(['/inicio'])) ?>">Voltar</button>
        </div>
            ...
            <div class="post-header">
                ...
                <?php if (!empty($canRemove)): ?>
                    ...
                    <button
                        ...
                        data-confirm="Tens a certeza que queres banir/remover este post?"
                        aria-label="Banir post">
                        <i class="bi <?= ($isAdminViewer && $isReviewMode) ? 'bi-hammer' : 'bi-trash' ?> fs-4"></i>
                    </button>
                    <?= Html::endForm() ?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body ">
                    <?= Html::beginForm(['/reportar'], 'post', ['id' => 'post-report-form']) ?>
                    <?= Html::hiddenInput('target_type', 'post') ?>
                    <?= Html::hiddenInput('target_user_id', (int) ($post['user_id'] ?? 0)) ?>
                    <?= Html::hiddenInput('target_post_id', $postId) ?>
                    <div class="mb-3">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-danger" form="post-report-form">Reportar</button>
                </div>
            </div>
        </div>
    <?php endif; ?>
...
document.addEventListener('click', function (event) {
    ...
    window.location.href = backButton.dataset.inicioUrl || '/inicio';
});
JS);
    ?>
