...
if ($selectedUser !== null) {
    ...
    if ($selectedPhotoPath === '' || strcasecmp($selectedPhotoPath, 'img/default.jpeg') === 0) {
        $selectedPhotoUrl = Url::to('@web/Img/default.jpeg');
    } else {
        $selectedPhotoUrl = Url::to('@web/' . ltrim($selectedPhotoPath, '/'));
    }
