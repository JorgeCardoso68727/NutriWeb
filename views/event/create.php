...
<div class="event-form-page container py-5">
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <div class="mb-3">
                <?= Html::a('Voltar', ['/event/index'], ['class' => 'btn btn-outline-secondary event-back-btn']) ?>
            </div>
            ...
            <div class="card border-0 shadow-sm event-form-card">
                <div class="card-body p-4 p-md-5 event-form-body">
                    ...
                    <div class="d-flex gap-2 mt-4">
                        <button type="submit" class="btn btn-success event-submit-btn">Guardar evento</button>
                        <?= Html::a('Cancelar', ['/event/index'], ['class' => 'btn btn-outline-secondary event-cancel-btn']) ?>
                    </div>
                    <?php ActiveForm::end(); ?>
                </div>
            </div>
